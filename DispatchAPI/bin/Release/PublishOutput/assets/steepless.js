...
var App = React.createClass({displayName: "App",
	getInitialState: function(){
		return {
			...
			routes: null,
			distanceUnit: localStorage['steepless:distanceUnit'] || 'mi',
			heightUnit: localStorage['steepless:heightUnit'] || 'ft',
			travelMode: 'driving'
		};
	},
			...
			React.createElement("div", null, 
				...
				React.createElement("div", {id: "sidebar"}, 
					React.createElement("header", null, 
						React.createElement("h1", null, React.createElement(Icon, {type: "mountains", width: "24", height: "24"}), " Dispatch Map"),
						React.createElement("ul", null, 
						React.createElement("li", null, React.createElement(Icon, {type: "mountains", width: "24", height: "24"}), " Foo "),
						React.createElement("li", null, React.createElement(Icon, {type: "mountains", width: "24", height: "24"}), " Bar ")
						),  
					),
