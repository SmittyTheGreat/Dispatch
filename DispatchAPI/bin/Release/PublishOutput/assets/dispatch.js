...
var App = React.createClass({displayName: "App",
	...
	render: function(){
		...
		var listWrapperClass = 'orderListWrapper' + (!this.state.showingList ? ' inactivePanel' : '')
		var orderDetailsWrapperClass = 'orderDetailsWrapper' + (!this.state.showingOrder ? ' inactivePanel' : '')
		var orderEditDetailsWrapperClass = 'orderEditDetailsWrapper' + (!this.state.editingOrder ? ' inactivePanel' : '')
		...
		return (
			React.createElement("div", null, 
				...
				React.createElement("div", {id: "sidebar"}, 
					...
					React.createElement("div", {className:orderEditDetailsWrapperClass},
